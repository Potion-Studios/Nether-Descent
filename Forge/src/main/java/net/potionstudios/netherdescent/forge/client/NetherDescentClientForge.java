...
public class NetherDescentClientForge {
	 ...
	 * @param busGroup The event bus to register the client side of the mod to.
	 */
	public static void init(final BusGroup busGroup) {
		FMLClientSetupEvent.getBus(busGroup).addListener((FMLClientSetupEvent _) -> NetherDescentClient.onInitialize());
