...
public class AdvancementGenerator implements ForgeAdvancementProvider.AdvancementGenerator {
	...
	public void generate(HolderLookup.@NotNull Provider arg, @NotNull Consumer<Advancement> consumer, @NotNull ExistingFileHelper existingFileHelper) {
		Advancement root = Advancement.Builder.advancement()
				.addCriterion("tick", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.location().setDimension((Level.NETHER)).build()))
				.display(
		...
		Advancement arisian_undergrowth = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), List.of(NetherDescentBiomes.ARISIAN_UNDERGROWTH))
				.parent(root)
				.display(
		...
		Advancement.Builder.advancement()
				...
				.addCriterion("step_on_thorn_sprout", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(NetherDescentBlocks.THORN_SPROUT.get()).build()).build()))
				.display(
		...
		Advancement.Builder.advancement()
				...
				.addCriterion("step_on_arisian_blossom", PlayerTrigger.TriggerInstance.located(EntityPredicate.Builder.entity().steppingOn(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(NetherDescentBlocks.ARISIAN_LEAVES.get()).build()).build()).build()))
				.addCriterion("step_on_arisian_leaves", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(NetherDescentBlocks.ARISIAN_BLOSSOM.getBlock()).build()).build()))
				.display(
		...
		Advancement crimson_gardens = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), List.of(NetherDescentBiomes.CRIMSON_GARDENS))
				.parent(root)
				.display(
		...
		Advancement.Builder.advancement()
				.addCriterion("projectile_hit_fungal_bulbs", FungalBulbsBlockTrigger.TriggerInstance.fungalBulbsHit(ContextAwarePredicate.ANY))
		...
		Advancement project_pendorite = Advancement.Builder.advancement()
		...
		Advancement pendorite_fire_rod = Advancement.Builder.advancement()
		...
		Advancement embur_bog = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), List.of(NetherDescentBiomes.EMBUR_BOG))
				.parent(root)
				.display(
		...
		Advancement killHornet = Advancement.Builder.advancement()
		...
		Advancement.Builder.advancement()
				...
				.display(
						...
						null,
						FrameType.CHALLENGE, false, true, false
				).save(consumer, NetherDescent.id("embur_bog/place_flower_near_hornet"), existingFileHelper);

		Advancement runOn = Advancement.Builder.advancement()
				.addCriterion("sprint_on_embur_gel", PlayerTrigger.TriggerInstance.located(EntityPredicate.Builder.entity()
						.steppingOn(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(NetherDescentBlocks.EMBUR_GEL_BLOCK.get()).build()).build())
						.flags(EntityFlagsPredicate.Builder.flags().setSprinting(true).build()).build()
				))
				.parent(embur_bog)
				.display(
				...
				.addCriterion("boat_ride_on_embur_gel",
						PlayerTrigger.TriggerInstance.located(
								EntityPredicate.Builder.entity()
										.vehicle(
												EntityPredicate.Builder.entity()
														.of(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath("c", "boats")))  //TODO: This is Fabric Only in this MC Version
														.steppingOn(
																LocationPredicate.Builder.location()
																		.setBlock(BlockPredicate.Builder.block().of(NetherDescentBlocks.EMBUR_GEL_BLOCK.get()).build()).build()
														)
														.build()
										).build()
						)
		...
		Advancement blueFortress = Advancement.Builder.advancement()
				.addCriterion("blue_fortress", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.location().setStructure(NetherDescentStructures.BLUE_FORTRESS).build()))
				.parent(embur_bog)
				.display(
		...
		Advancement soulBlazeRod = Advancement.Builder.advancement()
		...
		Advancement sythian_torrids = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), List.of(NetherDescentBiomes.SYTHIAN_TORRIDS))
				.parent(root)
				.display(
		...
		Advancement renewableBusiness = Advancement.Builder.advancement()
		...
		Advancement.Builder.advancement()
				...
				.addCriterion("place_stalk_on_farmland", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(NetherDescentBlocks.SYTHIAN_FARMLAND.get()).build()), ItemPredicate.Builder.item().of(NetherDescentBlocks.SYTHIAN_STALK.getItem())))
				.display(
		...
		Advancement wailing_garth = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), List.of(NetherDescentBiomes.WAILING_GARTH))
				.parent(root)
				.display(
		...
		Advancement elevator = Advancement.Builder.advancement()
		...
		VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), NetherDescentBiomes.BIOME_FACTORIES.keySet().stream().sorted().toList())
				.parent(root)
