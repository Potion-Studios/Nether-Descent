...
public class ModelGenerators {
	...
	private static class ItemModelGenerators extends ItemModelProvider {
		...
		private ItemModelBuilder simpleBlockItem(Block block) {
			return simpleBlockItem(Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(block)));
		}

		private ItemModelBuilder simpleBlockItem(ResourceLocation block) {
		...
		private ItemModelBuilder handheldItem(Item item) {
			return handheldItem(Objects.requireNonNull(key(item)));
		}
