...
public class NetherDescentBiomes {
	...
	public static final ResourceKey<Biome> WAILING_GARTH = createBiome("wailing_garth", NetherDescentBiomeBuilder::wailingGarth, NetherDescentBiomeTags.StructureHasTags.HAS_HANGING_CHAINS);
