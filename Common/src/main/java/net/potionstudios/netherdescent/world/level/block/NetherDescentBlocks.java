...
public class NetherDescentBlocks {
    ...
    public static final Supplier<Block> BLUE_NETHERRACK = registerBlockItem("blue_netherrack", BlueNetherrackBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERRACK));
    ...
    public static final Supplier<NDMossyCarpetBlock> EMBUR_MOSS_CARPET = registerBlockItem("embur_moss_carpet", NDMossyCarpetBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.MOSS_CARPET).mapColor(MapColor.COLOR_ORANGE));
    public static final Supplier<HangingMossBlock> EMBUR_HANGING_MOSS = registerBlockItem("embur_hanging_moss", HangingMossBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TWISTING_VINES).mapColor(MapColor.COLOR_ORANGE).noCollission().strength(0.2F).dynamicShape());
    ...
    public static final Supplier<HangingDoublePlantBlock> TALL_ARISIAN_DANDELIONS = registerBlockItem("tall_arisian_dandelions", HangingDoublePlantBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.DANDELION).lightLevel(state -> 12).mapColor(MapColor.COLOR_LIGHT_BLUE));
    ...
    public static final Supplier<ArisianLeavesBlock> ARISIAN_LEAVES = registerBlockItem("arisian_leaves", ArisianLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).lightLevel((state) -> state.getValue(ArisianLeavesBlock.LIT) ? 14 : 0));
    ...
    public static final PottedBlock SYTHIAN_ROOTS = new PottedBlock("sythian_roots",registerBlockItem("sythian_roots", SythianRootsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CRIMSON_ROOTS).mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final Supplier<Block> SYTHIAN_SHOOT = registerBlock("sythian_shoot", SythianShootBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_SAPLING).lightLevel((state) -> 5));
    ...
    public static final Supplier<ScaffoldingBlock> SYTHIAN_SCAFFOLDING = registerBlock("sythian_scaffolding", SythianScaffoldingBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.SCAFFOLDING).mapColor(MapColor.COLOR_YELLOW).lightLevel((blockState) -> 14));
    ...
    public static final Supplier<CrimsonCarpetBlock> CRIMSON_CARPET = registerBlockItem("crimson_carpet", CrimsonCarpetBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.RED_CARPET).sound(SoundType.MOSS_CARPET));

    public static final Supplier<FungalBulbsBlock> FUNGAL_BULBS = registerBlockItem("fungal_bulbs", FungalBulbsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.SHROOMLIGHT).lightLevel((state) -> 13).instabreak());
    ...
    public static final Supplier<WallTorchBlock> PENDORITE_WALL_TORCH = register("pendorite_wall_torch", () -> new NDWallTorchBlock(NetherDescentParticles.PENDORITE_FIRE_FLAME, Blocks.wallVariant(PENDORITE_TORCH.get(), true).noCollission().instabreak().lightLevel((blockStatex) -> 14).sound(SoundType.WOOD).pushReaction(PushReaction.DESTROY).setId(key("pendorite_wall_torch"))));
    public static final Supplier<ChainBlock> PENDORITE_CHAIN = registerBlockItem("pendorite_chain", ChainBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.CHAIN));
