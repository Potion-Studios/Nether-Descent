...
public class NetherDescentBlocks {
	...
	public static final Supplier<WailingFungalGillsBlock> WAILING_FUNGAL_GILLS = registerBlock("wailing_fungal_gills", () -> new WailingFungalGillsBlock(BlockBehaviour.Properties.of()));
