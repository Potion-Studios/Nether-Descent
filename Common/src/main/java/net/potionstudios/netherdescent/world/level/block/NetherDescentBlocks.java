...
public class NetherDescentBlocks {
    ...
    public static final Supplier<EmburVineBlock> EMBUR_GEL_VINES = registerBlockItem("embur_gel_vines", () -> new EmburVineBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TWISTING_VINES).mapColor(MapColor.COLOR_ORANGE).noCollission().speedFactor(1.2F).strength(0.2F).dynamicShape()));
    public static final Supplier<EmburVinePlantBlock> EMBUR_GEL_VINES_PLANT = registerBlock("embur_gel_vines_plant", () -> new EmburVinePlantBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TWISTING_VINES_PLANT).mapColor(MapColor.COLOR_ORANGE).noCollission().speedFactor(1.2F).strength(0.2F).dynamicShape()));
    ...
    public static final Supplier<RootsBlock> SYTHIAN_ROOTS = registerBlockItem("sythian_roots", () -> new RootsBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CRIMSON_ROOTS).mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final Supplier<NyliumBlock> CRIMSON_BLACKSTONE_NYLIUM = registerBlockItem("crimson_blackstone_nylium", () -> new NetherDescentNyliumBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CRIMSON_NYLIUM).mapColor(MapColor.COLOR_RED), Blocks.BLACKSTONE, null));
