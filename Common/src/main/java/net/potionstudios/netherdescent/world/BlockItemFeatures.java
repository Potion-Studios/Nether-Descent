...
public class BlockItemFeatures {
    ...
    public static void registerCompostables(BiConsumer<ItemLike, Float> consumer) {
        ...
        compostItems(consumer, 0.5F, NetherDescentBlocks.EMBUR_SPROUTS.get(), NetherDescentBlocks.SYTHIAN_SPROUTS.get(), NetherDescentBlocks.ARISIAN_SPROUTS.get());
        ...
        compostItems(consumer, 0.65F, NetherDescentBlocks.EMBUR_ROOTS.get(), NetherDescentBlocks.TALL_EMBUR_ROOTS.get(), NetherDescentBlocks.TALL_CRIMSON_ROOTS.get(),
                NetherDescentBlocks.FUNGAL_BULBS.get(), NetherDescentBlocks.TALL_CRIMSON_FUNGI.get(), NetherDescentBlocks.SYTHIAN_ROOTS.get());
