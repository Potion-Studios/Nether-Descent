...
public class NetherDescentWoodSet {
    ...
    public NetherDescentWoodSet(BlockSetType blockSetType, MapColor mapColor, LogStem logstem, GrowerItem growerItem, Supplier<? extends Block> requiredBlock, ResourceKey<ConfiguredFeature<?, ?>> feature, @Nullable ResourceKey<ConfiguredFeature<?, ?>> hangingFeature, boolean hanging) {
        ...
        this.logstem = NetherDescentBlocks.registerBlockItem(name + "_" + logstem.getName(), RotatedPillarBlock::new, Blocks.netherStemProperties(mapColor));
        this.wood = NetherDescentBlocks.registerBlockItem(name + "_" + logstem.getWoodName(), RotatedPillarBlock::new, BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(2.0F).sound(SoundType.NETHER_WOOD));
        this.strippedLogStem = NetherDescentBlocks.registerBlockItem("stripped_" + name + "_" + logstem.getName(), RotatedPillarBlock::new, Blocks.netherStemProperties(mapColor));
        this.strippedWood = NetherDescentBlocks.registerBlockItem("stripped_" + name + "_" + logstem.getWoodName(), RotatedPillarBlock::new, BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(2.0F).sound(SoundType.NETHER_WOOD));
        this.planks = NetherDescentBlocks.registerBlockItem(name + "_planks", Block::new, BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.NETHER_WOOD));
        this.stairs = NetherDescentBlocks.registerBlockItem(name + "_stairs", (properties) -> new StairBlock(planks.get().defaultBlockState(), properties), BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.NETHER_WOOD));
        this.slab = NetherDescentBlocks.registerBlockItem(name + "_slab", SlabBlock::new, BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.NETHER_WOOD));
        this.fence = NetherDescentBlocks.registerBlockItem(name + "_fence", FenceBlock::new, BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.NETHER_WOOD));
        this.fenceGate = NetherDescentBlocks.registerBlockItem(name + "_fence_gate", (properties) -> new FenceGateBlock(woodType, properties), BlockBehaviour.Properties.of().mapColor(mapColor).forceSolidOn().instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F));
        this.door = NetherDescentBlocks.registerBlockItem(name + "_door", (properties) -> new DoorBlock(woodType.setType(), properties), BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(3.0F).noOcclusion().pushReaction(PushReaction.DESTROY));
        this.trapdoor = NetherDescentBlocks.registerBlockItem(name + "_trapdoor", (properties) -> new TrapDoorBlock(woodType.setType(), properties), BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never));
        this.pressurePlate = NetherDescentBlocks.registerBlockItem(name + "_pressure_plate", (properties) -> new PressurePlateBlock(woodType.setType(), properties), BlockBehaviour.Properties.of().mapColor(mapColor).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(0.5F).pushReaction(PushReaction.DESTROY));
        this.button = NetherDescentBlocks.registerBlockItem(name + "_button", (properties) -> new ButtonBlock(blockSetType, 30, properties), Blocks.buttonProperties().mapColor(mapColor));
        Supplier<? extends BushBlock> fungus = NetherDescentBlocks.registerBlockItem(name + "_" + growerItem.getName(), hanging ? (properties) -> new HangingFungusBlock(feature, hangingFeature, requiredBlock.get(), properties): (properties) -> new NDFungusBlock(feature, requiredBlock.get(), properties), BlockBehaviour.Properties.ofFullCopy(Blocks.CRIMSON_FUNGUS).mapColor(mapColor));
        this.growerItem = new PottedBlock(fungus, NetherDescentBlocks.register("potted_" + name + "_" + growerItem.getName(), properties -> PlatformHandler.PLATFORM_HANDLER.createPottedBlock(fungus, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.FLOWER_POT)));
        NetherDescentBlocks.BLOCKS.add(this.growerItem.pottedBlock());
        this.bookshelf = NetherDescentBlocks.registerBlockItem(name + "_bookshelf", Block::new, BlockBehaviour.Properties.of().mapColor(mapColor).instrument(NoteBlockInstrument.BASS).strength(1.5F).sound(SoundType.NETHER_WOOD));
        ...
        this.sign = NetherDescentBlocks.register(name + "_sign", (properties) ->  new NetherDescentStandingSignBlock(woodType, properties), BlockBehaviour.Properties.of().mapColor(mapColor).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F));
        this.wallSign = NetherDescentBlocks.register(name + "_wall_sign", () -> new NetherDescentWallSignBlock(woodType, Blocks.wallVariant(sign.get(), true).mapColor(mapColor).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F).setId(NetherDescent.key(Registries.BLOCK, name + "_wall_sign"))));
        ...
        this.hangingSign = NetherDescentBlocks.register(name + "_hanging_sign", (properties) -> new NetherDescentCeilingHangingSignBlock(woodType, properties), BlockBehaviour.Properties.of().mapColor(mapColor).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F));
        this.wallHangingSign = NetherDescentBlocks.register(name + "_wall_hanging_sign", () -> new NetherDescentWallHangingSignBlock(woodType, Blocks.wallVariant(hangingSign.get(), true).mapColor(mapColor).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F).setId(NetherDescent.key(Registries.BLOCK, name + "_wall_hanging_sign"))));
