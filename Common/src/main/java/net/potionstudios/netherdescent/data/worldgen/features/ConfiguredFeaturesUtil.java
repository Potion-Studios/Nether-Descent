...
public class ConfiguredFeaturesUtil {
    ...
    @SafeVarargs
    protected static RandomFeatureConfiguration createRandomWeightedConfiguredFeature(HolderGetter<ConfiguredFeature<?, ?>> lookup, ResourceKey<ConfiguredFeature<?, ?>>... configuredFeatures) {
    ...
    protected static <FC extends FeatureConfiguration, F extends Feature<FC>> ResourceKey<ConfiguredFeature<?, ?>> createConfiguredFeature(String id, Supplier<? extends F> feature, Supplier<? extends FC> config) {
        ResourceKey<ConfiguredFeature<?, ?>> configuredFeatureResourceKey = registerKey(id);
    ...
    protected static <FC extends FeatureConfiguration, F extends Feature<FC>> ResourceKey<ConfiguredFeature<?, ?>> createConfiguredFeature(String id, F feature, Supplier<? extends FC> config) {
        ResourceKey<ConfiguredFeature<?, ?>> configuredFeatureResourceKey = registerKey(id);
    ...
    protected static <FC extends FeatureConfiguration, F extends Feature<FC>> Holder<ConfiguredFeature<?, ?>> createConfiguredFeature(F feature, Supplier<? extends FC> config) {
        return Holder.direct(new ConfiguredFeature<>(feature, config.get()));
    }

    protected static <FC extends FeatureConfiguration, F extends Feature<FC>> Holder<ConfiguredFeature<?, ?>> createConfiguredFeature(F feature, FC config) {
...
/*
    ...
    protected static ResourceKey<ConfiguredFeature<?, ?>> createSimpleBlockConfiguredFeatureWithState(String id, Supplier<BlockState> state) {
    ...
    private static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return NetherDescent.key(Registries.CONFIGURED_FEATURE, name);
    }
