...
public class NetherDescentTreePlacements {
	...
	public static final ResourceKey<PlacedFeature> ARISIAN_ROOTS_HANGING = PlacedFeaturesUtil.createPlacedFeature("arisian_roots_hanging", NetherDescentTreeFeatures.HANGING_ARISIAN_ROOTS, () -> List.of(CountOnEveryLayerPlacement.of(10), BiomeFilter.biome()));
