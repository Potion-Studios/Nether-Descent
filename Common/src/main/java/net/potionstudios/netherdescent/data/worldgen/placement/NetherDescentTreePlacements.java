...
public class NetherDescentTreePlacements {
	...
	public static final ResourceKey<PlacedFeature> WAILING_FUNGI_TREES = PlacedFeaturesUtil.createPlacedFeature("wailing_fungi_trees", NetherDescentTreeFeatures.WAILING_FUNGI_TREES, () -> List.of(CountOnEveryLayerPlacement.of(3), BiomeFilter.biome()));
