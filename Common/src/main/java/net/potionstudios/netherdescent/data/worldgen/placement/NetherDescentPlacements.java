...
public class NetherDescentPlacements {
	...
	public static final ResourceKey<PlacedFeature> EMBUR_MOSS_CARPET_PATCH = PlacedFeaturesUtil.createPlacedFeature("embur_moss_carpet_patch", NetherDescentFeatures.EMBUR_MOSS_CARPET_PATCH, () -> List.of(
            ...
            EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.allOf(
                BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), NetherDescentBlocks.EMBUR_MOSS_BLOCK.get()),
	...
	public static final ResourceKey<PlacedFeature> ARISIAN_MOSS_CARPET_PATCH = PlacedFeaturesUtil.createPlacedFeature("arisian_moss_carpet_patch", NetherDescentFeatures.ARISIAN_MOSS_CARPET_PATCH, () -> List.of(
			...
			PlacementUtils.RANGE_10_10,
			EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.allOf(
					BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), NetherDescentBlocks.ARISIAN_MOSS_BLOCK.get()),
					BlockPredicate.not(BlockPredicate.solid())
			), 12),
			BiomeFilter.biome()));
