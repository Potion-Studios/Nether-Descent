...
public class ModelGenerator extends ModelProvider {
	...
	protected void registerModels(@NotNull BlockModelGenerators blockModels, @NotNull ItemModelGenerators itemModels) {
		...
		Variant dandelion2 = BlockModelGenerators.plainModel(ModelLocationUtils.getModelLocation(NetherDescentBlocks.ARISIAN_DANDELIONS.get(), "2"));
		blockModels.blockStateOutput.accept(MultiVariantGenerator.dispatch(NetherDescentBlocks.ARISIAN_DANDELIONS.get()).with(
				BlockModelGenerators.createBooleanModelDispatch(HangingNDBushBlock.HANGING,
						BlockModelGenerators.variants(dandelion, dandelion.with(BlockModelGenerators.Y_ROT_90), dandelion.with(BlockModelGenerators.Y_ROT_180), dandelion.with(BlockModelGenerators.Y_ROT_270), dandelion2, dandelion2.with(BlockModelGenerators.Y_ROT_90), dandelion2.with(BlockModelGenerators.Y_ROT_180), dandelion2.with(BlockModelGenerators.Y_ROT_270)),
						BlockModelGenerators.variants(dandelion.with(BlockModelGenerators.X_ROT_180), dandelion.with(BlockModelGenerators.X_ROT_180).with(BlockModelGenerators.Y_ROT_90), dandelion.with(BlockModelGenerators.X_ROT_180).with(BlockModelGenerators.Y_ROT_180), dandelion.with(BlockModelGenerators.X_ROT_180).with(BlockModelGenerators.Y_ROT_270), dandelion2.with(BlockModelGenerators.X_ROT_180), dandelion2.with(BlockModelGenerators.X_ROT_180).with(BlockModelGenerators.Y_ROT_90), dandelion2.with(BlockModelGenerators.X_ROT_180).with(BlockModelGenerators.Y_ROT_180), dandelion2.with(BlockModelGenerators.X_ROT_180).with(BlockModelGenerators.Y_ROT_270))
				)));
		...
		Variant lily = BlockModelGenerators.plainModel(ModelLocationUtils.getModelLocation(NetherDescentBlocks.EMBUR_LILY.get()));
		...
		blockModels.blockStateOutput.accept(MultiVariantGenerator.dispatch(NetherDescentBlocks.WAILING_BULB_BLOSSOM.get())
				.with(PropertyDispatch.initial(WailingBulbBlossomBlock.ACTIVE)
						.select(true, BlockModelGenerators.plainVariant(ModelTemplates.create("netherdescent:wailing_bulb_blossom").extend().renderType(mcLocation("cutout")).build().create(ModelLocationUtils.getModelLocation(NetherDescentBlocks.WAILING_BULB_BLOSSOM.get(), "_active"),
								...
								blockModels.modelOutput)))
						.select(false, BlockModelGenerators.plainVariant(ModelLocationUtils.getModelLocation(NetherDescentBlocks.WAILING_BULB_BLOSSOM.get())))));
		...
		blockModels.blockStateOutput
				.accept(
						MultiVariantGenerator.dispatch(NetherDescentBlocks.SYTHIAN_ROOTS.get())
								.with(
										PropertyDispatch.initial(BlockStateProperties.FACING)
												.select(Direction.UP, BlockModelGenerators.plainVariant(sythianRoots))
												.select(Direction.DOWN, BlockModelGenerators.plainVariant(sythianRoots))
												.select(Direction.NORTH, BlockModelGenerators.plainVariant(sythainRootsWall))
												.select(Direction.WEST, BlockModelGenerators.plainVariant( sythainRootsWall).with(BlockModelGenerators.Y_ROT_270))
												.select(Direction.EAST, BlockModelGenerators.plainVariant(sythainRootsWall).with(BlockModelGenerators.Y_ROT_90))
												.select(Direction.SOUTH, BlockModelGenerators.plainVariant(sythainRootsWall).with(BlockModelGenerators.Y_ROT_180))
								)
				);
		...
		itemModels.generateTwoLayerDyedItem(NetherDescentItems.PENDORITE_WOLF_ARMOR.get());
						...
						MultiPartGenerator.multiPart(NetherDescentBlocks.PENDORITE_BARS.get())
								...
								.with(
										BlockModelGenerators.condition()
												...
												.term(BlockStateProperties.SOUTH, false)
												.term(BlockStateProperties.WEST, false),
										BlockModelGenerators.plainVariant(ModelLocationUtils.getModelLocation(NetherDescentBlocks.PENDORITE_BARS.get(), "_cap")).with(BlockModelGenerators.Y_ROT_90)
								)
								.with(
										BlockModelGenerators.condition()
												.term(BlockStateProperties.NORTH, false)
		...
		//Crimson
		blockModels.blockStateOutput.accept(MultiVariantGenerator.dispatch(NetherDescentBlocks.CRIMSON_CARPET.get(),
				BlockModelGenerators.variants(
						BlockModelGenerators.plainModel(ModelLocationUtils.getModelLocation(NetherDescentBlocks.CRIMSON_CARPET.get())),
						BlockModelGenerators.plainModel(ModelLocationUtils.getModelLocation(NetherDescentBlocks.CRIMSON_CARPET.get(), "2"))
				)));
		...
		blockModels.blockStateOutput
				.accept(
						MultiVariantGenerator.dispatch(NetherDescentBlocks.CRIMSON_BERRY_BUSH.get())
								.with(
	...
	private void createNetherrack(BlockModelGenerators blockModels, Block block) {
		Variant variant = BlockModelGenerators.plainModel(TexturedModel.CUBE.create(block, blockModels.modelOutput));
		blockModels.blockStateOutput.accept(MultiVariantGenerator.dispatch(block, BlockModelGenerators.variants(variant, variant.with(BlockModelGenerators.X_ROT_90), variant.with(BlockModelGenerators.X_ROT_180), variant.with(BlockModelGenerators.X_ROT_270), variant.with(BlockModelGenerators.Y_ROT_90), variant.with(BlockModelGenerators.Y_ROT_90.then(BlockModelGenerators.X_ROT_90)), variant.with(BlockModelGenerators.Y_ROT_90.then(BlockModelGenerators.X_ROT_180)),
				variant.with(BlockModelGenerators.Y_ROT_90.then(BlockModelGenerators.X_ROT_270)), variant.with(BlockModelGenerators.Y_ROT_180), variant.with(BlockModelGenerators.Y_ROT_180.then(BlockModelGenerators.X_ROT_90)), variant.with(BlockModelGenerators.Y_ROT_180.then(BlockModelGenerators.X_ROT_180)), variant.with(BlockModelGenerators.Y_ROT_180.then(BlockModelGenerators.X_ROT_270)), variant.with(BlockModelGenerators.Y_ROT_270), variant.with(BlockModelGenerators.Y_ROT_270.then(BlockModelGenerators.X_ROT_90)),
				variant.with(BlockModelGenerators.Y_ROT_270.then(BlockModelGenerators.X_ROT_180)), variant.with(BlockModelGenerators.Y_ROT_270.then(BlockModelGenerators.X_ROT_270)))));
