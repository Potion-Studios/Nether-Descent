...
public class ParticleDescriptionGenerator extends ParticleDescriptionProvider {
    ...
    protected void addDescriptions() {
	    ...
	    spriteSet(NetherDescentParticles.SYTHIAN_LEAF.get(), NetherDescent.id("sythian_leaf"));
	    spriteSet(NetherDescentParticles.PENDORITE_FIRE_FLAME.get(), NetherDescent.id("pendorite_fire_flame"));
	    spriteSet(NetherDescentParticles.ARISIAN_LEAF.get(), NetherDescent.id("arisian_leaf"));
    }
}
