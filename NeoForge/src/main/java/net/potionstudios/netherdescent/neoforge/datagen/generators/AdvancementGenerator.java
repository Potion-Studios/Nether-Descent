...
public class AdvancementGenerator extends AdvancementProvider {
    ...
    private static class Generator implements AdvancementSubProvider {
        ...
        public void generate(HolderLookup.@NonNull Provider provider, @NonNull Consumer<AdvancementHolder> consumer) {
            HolderLookup.RegistryLookup<Block> blockLookUp = provider.lookupOrThrow(Registries.BLOCK);
            HolderLookup.RegistryLookup<EntityType<?>> entityLookUp = provider.lookupOrThrow(Registries.ENTITY_TYPE);
            AdvancementHolder root = Advancement.Builder.advancement()
                    ...
                    .save(consumer, NetherDescent.id("root"));

            AdvancementHolder arisian_undergrowth = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), provider, List.of(NetherDescentBiomes.ARISIAN_UNDERGROWTH))
                    .parent(root)
                    .display(
                    ...
                    ).save(consumer, NetherDescent.id("arisian_undergrowth/root"));

            Advancement.Builder.advancement()
                    .parent(arisian_undergrowth)
                    .addCriterion("step_on_thorn_sprout", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.THORN_SPROUT.get()))))
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("arisian_undergrowth/step_on_thorn_sprout"));

            Advancement.Builder.advancement()
                    .parent(arisian_undergrowth)
                    .requirements(AdvancementRequirements.Strategy.OR)
                    .addCriterion("step_on_arisian_blossom", PlayerTrigger.TriggerInstance.located(EntityPredicate.Builder.entity().steppingOn(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.ARISIAN_LEAVES.get())))))
                    .addCriterion("step_on_arisian_leaves", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.ARISIAN_BLOSSOM.get()))))
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("arisian_undergrowth/step_on_arisian_leaves_blossom"));

            AdvancementHolder crimson_gardens = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), provider, List.of(NetherDescentBiomes.CRIMSON_GARDENS))
                    .parent(root)
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("crimson_gardens/root"));
            ...
            Advancement.Builder.advancement()
                    ...
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("crimson_gardens/fungal_bulbs"));
            ...
            AdvancementHolder project_pendorite = Advancement.Builder.advancement()
                    ...
                    .save(consumer, NetherDescent.id("crimson_gardens/raw_pendorite"));
            ...
            Advancement.Builder.advancement()
                    ...
                    .save(consumer, NetherDescent.id("crimson_gardens/pendorite_wolf_armor"));
            ...
            Advancement.Builder.advancement()
                    ...
                    .save(consumer, NetherDescent.id("crimson_gardens/pendorite_horse_armor"));
            ...
            AdvancementHolder pendorite_fire_rod = Advancement.Builder.advancement()
                    ...
                    .save(consumer, NetherDescent.id("crimson_gardens/pendorite_fire_rod"));

            Advancement.Builder.advancement()
                    .addCriterion("summon_pendorite_blaze", SummonedEntityTrigger.TriggerInstance.summonedEntity(EntityPredicate.Builder.entity().entityType(EntityTypePredicate.of(entityLookUp, NetherDescentEntityType.PENDORITE_BLAZE.get()))))
                    ...
                    .save(consumer, NetherDescent.id("crimson_gardens/summon_pendorite_blaze"));

            AdvancementHolder embur_bog = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), provider, List.of(NetherDescentBiomes.EMBUR_BOG))
                    .parent(root)
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("embur_bog/root"));

            AdvancementHolder killHornet = Advancement.Builder.advancement()
                    .addCriterion("kill_hornet", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(entityLookUp, NetherDescentEntityType.HORNET.get())))
                    .parent(embur_bog)
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("embur_bog/kill_hornet"));
            ...
            Advancement.Builder.advancement()
                    ...
                    ).save(consumer, NetherDescent.id("embur_bog/place_flower_near_hornet"));
            ...
            AdvancementHolder runOn = Advancement.Builder.advancement()
                    .addCriterion("sprint_on_embur_gel", PlayerTrigger.TriggerInstance.located(EntityPredicate.Builder.entity()
                            .steppingOn(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.EMBUR_GEL_BLOCK.get())))
                    ...
                    .save(consumer, NetherDescent.id("embur_bog/sprint_on_embur_gel"));
            ...
            Advancement.Builder.advancement()
                    .addCriterion("boat_ride_on_embur_gel",
                            PlayerTrigger.TriggerInstance.located(
                                    EntityPredicate.Builder.entity()
                                            .vehicle(
                                                    EntityPredicate.Builder.entity()
                                                            .of(entityLookUp, TagKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("c", "boats")))
                                                            .steppingOn(
                                                                    LocationPredicate.Builder.location()
                                                                            .setBlock(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.EMBUR_GEL_BLOCK.get()))
                                                            )
                                            )
                            )
                    ...
                    .display(
                            ...
                            null,
                            AdvancementType.CHALLENGE, false, true, false
                    ).save(consumer, NetherDescent.id("embur_bog/boat_ride_on_embur_gel"));


            AdvancementHolder blueFortress = Advancement.Builder.advancement()
                    .addCriterion("blue_fortress", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inStructure(provider.lookupOrThrow(Registries.STRUCTURE).getOrThrow(NetherDescentStructures.BLUE_FORTRESS))))
                    .parent(embur_bog)
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("embur_bog/find_blue_fortress"));
            ...
            AdvancementHolder soulBlazeRod = Advancement.Builder.advancement()
                    ...
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("embur_bog/obtain_soul_blaze_rod"));
            ...
            Advancement.Builder.advancement()
                    ...
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("embur_bog/obtain_soul_fire_rod"));

            AdvancementHolder sythian_torrids = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), provider, List.of(NetherDescentBiomes.SYTHIAN_TORRIDS))
                    .parent(root)
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("sythian_torrids/root"));
            ...
            AdvancementHolder renewableBusiness = Advancement.Builder.advancement()
                    ...
                    .save(consumer, NetherDescent.id("sythian_torrids/smelted_sythian_stalk"));

            Advancement.Builder.advancement()
                    .parent(renewableBusiness)
                    .addCriterion("place_stalk_on_farmland", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.SYTHIAN_FARMLAND.get())), ItemPredicate.Builder.item().of(provider.lookupOrThrow(Registries.ITEM), NetherDescentBlocks.SYTHIAN_STALK.getItem())))
                    .display(
                    ...
                    .save(consumer, NetherDescent.id("sythian_torrids/place_stalk_on_farmland"));
            ...
            Advancement.Builder.advancement()
                    ...
                    .save(consumer, NetherDescent.id("sythian_torrids/obtain_sythian_scaffolding"));

            AdvancementHolder wailing_garth = VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), provider, List.of(NetherDescentBiomes.WAILING_GARTH))
                    .parent(root)
                    .display(
                            ...
                            null,
                            AdvancementType.TASK, false, true, false
                    ).save(consumer, NetherDescent.id("wailing_garth/root"));

            Advancement.Builder.advancement()
                    .addCriterion("wailing_bulb_blossom", WailingTrigger.TriggerInstance.interactedWithBlock(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.WAILING_BULB_BLOSSOM.get())))
                    ...
                    ).save(consumer, NetherDescent.id("wailing_garth/step_on_wailing_bulb_blossom"));

            AdvancementHolder elevator = Advancement.Builder.advancement()
                    .addCriterion("wailing_gills", WailingTrigger.TriggerInstance.interactedWithBlock(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.WAILING_GILLS.get())))
                    .parent(wailing_garth)
                    .display(
                            ...
                            null,
                            AdvancementType.CHALLENGE, true, true, false
                    ).save(consumer, NetherDescent.id("wailing_garth/float_from_wailing_gills"));

            Advancement.Builder.advancement()
                    .parent(elevator)
                    .addCriterion("float_cow_from_wailing_gills", WailingTrigger.TriggerInstance.interactedWithPoweredBlockAndEntity(BlockPredicate.Builder.block().of(blockLookUp, NetherDescentBlocks.WAILING_GILLS.get()), MinMaxBounds.Ints.atLeast(1), EntityPredicate.Builder.entity().of(entityLookUp, EntityType.COW)))
                    .display(
                            Items.LEAD,
                            ...
                            null,
                            AdvancementType.CHALLENGE, true, true, false
                    ).save(consumer, NetherDescent.id("wailing_garth/float_cow_from_wailing_gills"));

            Advancement.Builder.advancement()
                    .addCriterion("kill_soul_ghast", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(entityLookUp, NetherDescentEntityType.SOUL_GHAST.get())))
                    .parent(wailing_garth)
                    .display(
                            ...
                            null,
                            AdvancementType.CHALLENGE, true, true, false
                    ).save(consumer, NetherDescent.id("wailing_garth/kill_soul_ghast"));

            VanillaAdventureAdvancements.addBiomes(Advancement.Builder.advancement(), provider, NetherDescentBiomes.BIOME_FACTORIES.keySet().stream().sorted().toList())
                    .parent(root)
                    ...
                    .save(consumer, NetherDescent.id("final_descent"));
        }
    }
