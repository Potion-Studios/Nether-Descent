...
public class SoundDefinitionsGenerator extends SoundDefinitionsProvider {
	...
	public void registerSounds() {
		...
		add(NetherDescentSounds.AMBIENT_SYTHIAN_TORRIDS_LOOP.get().value(), definition().with(sound(NetherDescent.id("ambient/nether/sythian_torrids/ambience")).stream().volume(0.1)));
		add(NetherDescentSounds.AMBIENT_SYTHIAN_TORRIDS_ADDITIONS.get().value(), definition().with(
				sound(NetherDescent.id("ambient/nether/sythian_torrids/addition1")).volume(0.1),
				sound(NetherDescent.id("ambient/nether/sythian_torrids/addition2")).volume(0.1),
				sound(NetherDescent.id("ambient/nether/sythian_torrids/addition3")).volume(0.1),
				sound(NetherDescent.id("ambient/nether/sythian_torrids/addition4")).volume(0.1),
				sound(NetherDescent.id("ambient/nether/sythian_torrids/addition5")).volume(0.1),
				sound(NetherDescent.id("ambient/nether/sythian_torrids/addition6")).volume(0.1)
		));
		...
		add(NetherDescentSounds.AMBIENT_CRIMSON_GARDENS_LOOP.get().value(), definition().with(sound(NetherDescent.id("ambient/nether/crimson_gardens/ambience")).stream().volume(0.1)));
		add(NetherDescentSounds.AMBIENT_CRIMSON_GARDENS_ADDITIONS.get().value(), definition().with(
				...
				sound(NetherDescent.id("ambient/nether/crimson_gardens/addition3")).volume(0.1),
				sound(NetherDescent.id("ambient/nether/crimson_gardens/addition4")).volume(0.1),
				sound(NetherDescent.id("ambient/nether/crimson_gardens/addition5")).volume(0.1),
				sound(NetherDescent.id("ambient/nether/crimson_gardens/addition6")).volume(0.1)
		));
