...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        NetherDescentWoodSet.woodsets().forEach(set -> {
            ...
            generateRecipes(set.family(), FeatureFlags.VANILLA_SET);
            ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.BUILDING_BLOCKS, set.bookshelf())
                    .define('#', set.planks())
                    .define('X', Items.BOOK)
                    .pattern("###")
                    .pattern("XXX")
                    ...
                    .save(output);
            ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, set.craftingTable())
                    .define('#', set.planks())
                    .pattern("##")
                    .pattern("##")
                    .group("planks")
	    ...
	    SimpleCookingRecipeBuilder.smelting(Ingredient.of(NetherDescentBlocks.BLUE_NETHERRACK.get()), RecipeCategory.MISC, CookingBookCategory.BLOCKS, NetherDescentItems.BLUE_NETHER_BRICK.get(), 0.1F, 200)
			    .unlockedBy(getHasName(NetherDescentBlocks.BLUE_NETHERRACK.get()), has(NetherDescentBlocks.BLUE_NETHERRACK.get()))
			    .save(output);

        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentBlocks.BLUE_NETHER_BRICK_FENCE.get(), 6)
		...
		ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.CHISELED_BLUE_NETHER_BRICKS.get())
        ...
        NDNineBlockStorageRecipes(itemHolderGetter, output, RecipeCategory.MISC, NetherDescentItems.EMBUR_GEL_BALL.get(), RecipeCategory.MISC, NetherDescentBlocks.EMBUR_GEL_BLOCK.get(), getSimpleRecipeName(NetherDescentBlocks.EMBUR_GEL_BLOCK.get()), null, getSimpleRecipeName(NetherDescentItems.EMBUR_GEL_BALL.get()), null);

        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentItems.SYTHIAN_SCAFFOLDING.get(), 6)
                .define('~', Items.STRING)
        ...
        twoByTwoPacker(RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.EMBUR_MOSS_BLOCK.get(), NetherDescentBlocks.EMBUR_CAVE_MOSS.get());
        ...
        ShapelessRecipeBuilder.shapeless(itemHolderGetter, RecipeCategory.MISC, NetherDescentBlocks.TALL_CRIMSON_FUNGI.get())
                .requires(Items.CRIMSON_FUNGUS, 2)
                .unlockedBy(getHasName(Items.CRIMSON_FUNGUS), has(Items.CRIMSON_FUNGUS))
                .save(output);

        ShapelessRecipeBuilder.shapeless(itemHolderGetter, RecipeCategory.MISC, Items.CRIMSON_FUNGUS, 2)
        ...
        oreSmelting(ImmutableList.of(NetherDescentBlocks.BLUE_NETHER_GOLD_ORE.get()), RecipeCategory.MISC, CookingBookCategory.BLOCKS, Items.GOLD_INGOT, 1.0F, 200, "gold_ingot");
        oreBlasting(ImmutableList.of(NetherDescentBlocks.BLUE_NETHER_GOLD_ORE.get()), RecipeCategory.MISC, CookingBookCategory.BLOCKS, Items.GOLD_INGOT, 1.0F, 100, "gold_ingot");

        SimpleCookingRecipeBuilder.smelting(Ingredient.of(NetherDescentBlocks.BLUE_NETHER_QUARTZ_ORE.get()), RecipeCategory.MISC, CookingBookCategory.BLOCKS, Items.QUARTZ, 0.2F, 200)
                .unlockedBy(getHasName(NetherDescentBlocks.BLUE_NETHER_QUARTZ_ORE.get()), has(NetherDescentBlocks.BLUE_NETHER_QUARTZ_ORE.get()))
                .save(output);
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(NetherDescentBlocks.BLUE_NETHER_QUARTZ_ORE.get()), RecipeCategory.MISC, CookingBookCategory.BLOCKS, Items.QUARTZ, 0.2F, 100)
                .unlockedBy(getHasName(NetherDescentBlocks.BLUE_NETHER_QUARTZ_ORE.get()), has(NetherDescentBlocks.BLUE_NETHER_QUARTZ_ORE.get()))
        ...
        oreSmelting(PENDORITE_SMELTABLES, RecipeCategory.MISC, CookingBookCategory.BLOCKS, NetherDescentItems.PENDORITE_INGOT.get(), 0.7F, 200, "pendorite_ingot");
        oreBlasting(PENDORITE_SMELTABLES, RecipeCategory.MISC, CookingBookCategory.BLOCKS, NetherDescentItems.PENDORITE_INGOT.get(), 0.7F, 100, "pendorite_ingot");
        ...
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.CHISELED_PENDORITE.get(), NetherDescentBlocks.CUT_PENDORITE.get(), 1);

        nineBlockStorageRecipes(RecipeCategory.MISC, NetherDescentItems.RAW_PENDORITE.get(), RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.RAW_PENDORITE_BLOCK.get());
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(NetherDescentBlocks.SYTHIAN_STALK.getItem()), RecipeCategory.MISC, CookingBookCategory.BLOCKS, Items.GOLD_NUGGET, 0.1F, 400)
                .unlockedBy(getHasName(NetherDescentBlocks.SYTHIAN_STALK.getItem()), has(NetherDescentBlocks.SYTHIAN_STALK.getItem()))
                .save(output, key("gold_nugget_from_smelting"));

        SimpleCookingRecipeBuilder.blasting(Ingredient.of(NetherDescentBlocks.SYTHIAN_STALK.getItem()), RecipeCategory.MISC, CookingBookCategory.BLOCKS, Items.GOLD_NUGGET, 0.1F, 200)
                .unlockedBy(getHasName(NetherDescentBlocks.SYTHIAN_STALK.getItem()), has(NetherDescentBlocks.SYTHIAN_STALK.getItem()))
                .save(output, key("gold_nugget_from_blasting"));
        ...
        slab(RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.CUT_PENDORITE_SLAB.get(), NetherDescentBlocks.CUT_PENDORITE.get());

        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.CUT_PENDORITE_STAIRS.get(), NetherDescentBlocks.CUT_PENDORITE.get());
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.CUT_PENDORITE_STAIRS.get(), NetherDescentBlocks.PENDORITE_BLOCK.get(), 4);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.CUT_PENDORITE_SLAB.get(), NetherDescentBlocks.CUT_PENDORITE.get(),2);
        stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, NetherDescentBlocks.CUT_PENDORITE_SLAB.get(), NetherDescentBlocks.PENDORITE_BLOCK.get(), 8);

	    ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentBlocks.PENDORITE_CAMPFIRE.get())
        ...
        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentBlocks.PENDORITE_BARS.get(), 16)
        ...
        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentBlocks.PENDORITE_TORCH.get(), 4)
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentBlocks.PENDORITE_LANTERN.get())
        ...
        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentBlocks.SOUL_FIRE_ROD.get(), 4)
        ...
        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentBlocks.BLAZE_FIRE_ROD.get(), 4)
        ...
        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.DECORATIONS, NetherDescentBlocks.PENDORITE_FIRE_ROD.get())
                .define('X', NetherDescentItems.PENDORITE_NUGGET.get())
        ...
        ShapelessRecipeBuilder.shapeless(itemHolderGetter, RecipeCategory.BREWING, NetherDescentItems.SOUL_BLAZE_POWDER.get(), 2)
                .requires(NetherDescentItems.SOUL_BLAZE_ROD.get())
                .unlockedBy(getHasName(NetherDescentItems.SOUL_BLAZE_ROD.get()), has(NetherDescentItems.SOUL_BLAZE_ROD.get()))
                .save(output);

        ShapelessRecipeBuilder.shapeless(itemHolderGetter, RecipeCategory.MISC, NetherDescentItems.SOUL_FIRE_CHARGE.get(), 3)
        ...
        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.MISC, NetherDescentBlocks.HORNET_NEST.get())
	...
	private void NDNineBlockStorageRecipes(HolderGetter<Item> itemHolderGetter, RecipeOutput recipeOutput, RecipeCategory unpackedCategory, ItemLike unpacked, RecipeCategory packedCategory, ItemLike packed, String packedName, @Nullable String packedGroup, String unpackedName, @Nullable String unpackedGroup) {
		ShapelessRecipeBuilder.shapeless(itemHolderGetter, unpackedCategory, unpacked, 9)
				.requires(packed)
				.group(unpackedGroup)
				.unlockedBy(getHasName(packed), has(packed))
				.save(recipeOutput, key(unpackedName));
		ShapedRecipeBuilder.shaped(itemHolderGetter, packedCategory, packed)
				.define('#', unpacked)
				.pattern("###")
				.pattern("###")
				.pattern("###")
				...
				.save(recipeOutput, key(packedName));
    }

	protected void stonecutterResultFromBase(@NotNull RecipeOutput recipeOutput, @NotNull RecipeCategory category, ItemLike result, ItemLike material, int resultCount) {
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(material), category, result, resultCount)
				.unlockedBy(getHasName(material), has(material))
				.save(recipeOutput, key(getConversionRecipeName(result, material) + "_stonecutting"));
	}
    ...
    private ResourceKey<Recipe<?>> key(String id) {
        return NetherDescent.key(Registries.RECIPE, id);
    }
}
