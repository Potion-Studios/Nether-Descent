...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        ShapelessRecipeBuilder.shapeless(itemHolderGetter, RecipeCategory.MISC, NetherDescentBlocks.MOSSY_BLUE_NETHER_BRICKS.getBase())
        ...
        NDNineBlockStorageRecipes(itemHolderGetter, RecipeCategory.MISC, NetherDescentItems.EMBUR_GEL_BALL.get(), RecipeCategory.MISC, NetherDescentBlocks.EMBUR_GEL_BLOCK.get(), getSimpleRecipeName(NetherDescentBlocks.EMBUR_GEL_BLOCK.get()), null, getSimpleRecipeName(NetherDescentItems.EMBUR_GEL_BALL.get()), null);
        ...
        ShapedRecipeBuilder.shaped(itemHolderGetter, RecipeCategory.COMBAT, NetherDescentItems.PENDORITE_WOLF_ARMOR.get())
	...
	private void NDNineBlockStorageRecipes(HolderGetter<Item> itemHolderGetter, RecipeCategory unpackedCategory, ItemLike unpacked, RecipeCategory packedCategory, ItemLike packed, String packedName, @Nullable String packedGroup, String unpackedName, @Nullable String unpackedGroup) {
		ShapelessRecipeBuilder.shapeless(itemHolderGetter, unpackedCategory, unpacked, 9)
				.requires(packed)
				.group(unpackedGroup)
				.unlockedBy(getHasName(packed), has(packed))
				.save(output, NetherDescent.key(Registries.RECIPE, unpackedName));
